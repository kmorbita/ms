        ...
        <div class="card profile-card">
            ...
            <div class="profile-body">
                <div class="image-area">
                    <img src="assets/images/login.jpg" alt="AdminBSB - Profile Image" height="150" />
                </div>
                <div class="content-area">
                    <h4>Materials and Supplies Borrower System</h4>
                    <!-- <p>Materials and Supply Inventory System</p> -->
                    <!-- <p>Administrator</p> -->
                </div>
            </div>
                ...
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-8 p-t-5">
                            ...
                            <div class="col-xs-12">
                                <button class="btn btn-block bg-dict waves-effect" type="submit">SIGN IN</button>
                            </div>
                        </div>
